...
export const SITE_URL = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://your-domain.com"
export const GITHUB_REPO_URL = "https://github.com/[your-username]/[your-repo]"
