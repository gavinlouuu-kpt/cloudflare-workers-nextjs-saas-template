...
export const SITE_NAME = "TickNow"
export const SITE_DESCRIPTION = "An AI-powered counting and tracking system for biomedical images."
export const SITE_URL = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://ticknow.org"
export const GITHUB_REPO_URL = "https://github.com/gavinlouuu-kpt/cloudflare-workers-nextjs-saas-template"
